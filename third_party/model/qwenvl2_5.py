...
class QwenVL2_5():
    def __init__(self, model_id="/gallery_orsay/minsu.park/VLMs/Qwen2.5-VL-72B-Instruct", gpu_num=None, batch_size=1, max_new_tokens=2048, temperature=0.7, do_sample=True, verbose=True):
        if gpu_num is None:
            device_map = "auto"
        else:
